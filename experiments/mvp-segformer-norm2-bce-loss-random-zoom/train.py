...
class HubmapDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Take random crop of size 128x128
        x_start = random.randint(0, 512 - 128)
        y_start = random.randint(0, 512 - 128)
        image = image[:, x_start:x_start+128, y_start:y_start+128]
        mask = mask[x_start:x_start+128, y_start:y_start+128]
