...
def get_model_instance_segmentation(num_classes):
    ...
    model = torchvision.models.detection.maskrcnn_resnet50_fpn_v2(weights="DEFAULT", weights_backbone=ResNet50_Weights.IMAGENET1K_V2, trainable_backbone_layers=5)
