...
class CFG:
    ...
    init_model_path = "/home/viktor/Documents/kaggle/hubmap-2023/experiments/mvp-segformer-norm2-bce-loss/ckpts/segformer_epoch_100.pt"
...
model = Segformer()
state_dict = torch.load(CFG.init_model_path)
